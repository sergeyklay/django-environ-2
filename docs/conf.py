...
project = 'django-environ-2'
copyright = '2021, Serghei Iakovlev and other contributors'
...
htmlhelp_basename = "django-environ-2-doc"
...
man_pages = [
    ("index", project, "django-environ-2 Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        "index",
        project,
        "django-environ-2 Documentation",
        author,
        project,
